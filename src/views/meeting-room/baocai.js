!function (e, t) {
  "undefined" != typeof module && module.exports ? module.exports = t() : "function" == typeof define && (define.amd || define.cmd)
    ? define(t) : e.Ali = t.call(e)
}(this, function () {
  "use strict";
  ...
  function r (e, t) {
    e.errorCode && console.error(t + " 发生异常: errorCode: " + e.errorCode + ", errorMessage: " + e.errorMessage)
  }
    ...
    return i.ua = navigator.userAgent, i.isAlipay = i.ua.indexOf("AlipayClient") > -1, i.alipayVersion = function () {
      ...
      if ("function" == typeof e[e.length - 1]) {
        ...
        e[e.length - 1] = function (o) {
          var o = o ? o : {};
          o.errorCode = o.error ? +o.error : 0, o.errorMessage = 0 == o.errorCode ? "调用成功" : o.errorMessage, r(o, e[0]), t(o)
        }
      }
      var o = function () {
      ...
      var r = { type: "title" };
      e(t) && (t = { text: t }), a(r, t), null == r.text ? console.error("setTitle: text 参数必填！") : r.title = r.text, i.call("setTitle", r), o({})
      ...
      var r = { url: "" };
      e(t) && (t = { url: t }), a(r, t), r.param && n("8.3") < 0 && /android/i.test(i.ua) && console.warn("Ali.pushWindow: android 版 param 参数请在 8.3 及以上版本使用");
      ...
      console.error("支付宝不支持 Ali.h5TradePay，支付宝请使用 Ali.tradePay"), t({ errorCode: 1, errorMessage: "接口不存在" })
      ...
      var o = setTimeout(function () {
        ...
        var e = { errorCode: 5, errorMessage: "调用超时" };
        t(e)
      }, e.timeout);
      ...
      n("8.3") < 0 ? (console.error("Ali.calendar.add: 在 8.3 及以上版本使用"), t({
        errorCode: 1,
        errorMessage: "接口不存在"
      ...
      a(o, e), o.imageFormat = o.format, "remoteurl" == o.dataType && (o.dataType = "dataurl"), o.dataType = o.dataType.slice(0, -3) + o.dataType.slice(-3).toUpperCase(), i.call("photo", o, function (e) {
        e.dataURL && (e.dataURL = "data:image/" + o.imageFormat + ";base64," + e.dataURL), e.photo = e.dataURL || e.fileURL, e.errorMessage = 10 == e.error ? "用户取消" : e.errorMessage, t(e)
      })
